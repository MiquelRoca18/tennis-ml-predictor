...
def test_endpoint(name: str, method: str, endpoint: str, data: Dict = None, expected_status: int = 200) -> Dict:
    """
...
def run_tests():
    ...
    results["total"] += 1
    response = test_endpoint(
        "GET /matches (fecha inválida)",
        "GET",
        "/matches?date=invalid-date",
        expected_status=400
    )
