...
class HeadToHeadCalculator:
    ...
    def calcular_h2h(self, jugador1_nombre, jugador2_nombre, fecha_partido, superficie=None):
        ...
        h2h_matches = self.df[
            (
                ((self.df['winner_name'] == jugador1_nombre) & (self.df['loser_name'] == jugador2_nombre)) |
                ((self.df['winner_name'] == jugador2_nombre) & (self.df['loser_name'] == jugador1_nombre))
            ) &
        ...
        if superficie:
            ...
            if len(h2h_superficie) > 0:
                victorias_superficie = len(h2h_superficie[h2h_superficie['winner_name'] == jugador1_nombre])
