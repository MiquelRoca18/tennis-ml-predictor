...
class Config:
    ...
    def validate(cls, strict=False):
        ...
        if strict:
            ...
            if not cls.ODDS_API_KEY:
                warnings.append("ODDS_API_KEY no configurada (funcionalidad de bookmakers limitada)")
    ...
    def print_config(cls, show_secrets=False):
        ...
        if show_secrets:
            ...
            print(f"   ODDS_API_KEY: {'✅ Configurada' if cls.ODDS_API_KEY else '❌ No configurada'}")
