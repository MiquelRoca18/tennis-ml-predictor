...
def tune_xgboost(X_train, y_train):
    ...
    tuner = HyperparameterTuner(modelo_base=modelo_base, param_grid=param_grid, cv=5)

    mejor_modelo, mejor_params = tuner.tune_random_search(
        X_train, y_train, n_iter=50, scoring="neg_brier_score"  # 50 combinaciones aleatorias
    )
...
def tune_lightgbm(X_train, y_train):
    ...
    mejor_modelo, mejor_params = tuner.tune_random_search(
        X_train, y_train, n_iter=50, scoring="neg_brier_score"
    )
